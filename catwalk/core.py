...
mort_table = pd.read_csv(
    pkg_resources.resource_stream(__name__, "tables/sa8990.csv"), index_col=0
)
lapse_table = pd.read_csv(
    pkg_resources.resource_stream(__name__, "tables/lapses.csv"), index_col=0
)
eco_table = pd.read_csv(
    pkg_resources.resource_stream(__name__, "tables/economic.csv"), index_col=0
)
